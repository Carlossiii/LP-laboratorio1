...
Página 4 de 11IMD0030 – Linguagem de Programação I | 2017.2
Laboratório 1
...
$(CC) -c $(CFLAGS) -o $@ $<
Página 5 de 11IMD0030 – Linguagem de Programação I | 2017.2
Laboratório 1
...
Página 6 de 11IMD0030 – Linguagem de Programação I | 2017.2
@echo
@echo
@echo
$(CC)
